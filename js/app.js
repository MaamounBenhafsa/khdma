...
function none_filter(){
  ...
  if (this.readyState == 4 && this.status == 200) {
   ...
   for (var i = 0; i < data2.length; i++) {
    document.getElementById('search-filter').innerHTML += '<div class="col-lg-3 col-md-6 mb-4" ><div class="card"><div class="view overlay"><a><div class="mask rgba-white-slight"></div></a></div><div class="card-body text-center"><h1><span class="badge  badge-primary">'+data2[i]["work_type"]+'</span></h1><h2>'+data2[i]["first_name"]+'  '+data2[i]["last_name"]+'</h2></a><h5><strong><a href="tel:0'+data2[i]["phone_number"]+'" class="dark-grey-text"><img src="https://annvivrqgp.cloudimg.io/v7/khadam.online/img/phone.png?width=34" >  0'+data2[i]["phone_number"]+'</a></strong></h5><h4 class="font-weight-bold blue-text"><strong>'+data2[i]["wilaya_place"]+'<br>'+data2[i]["commune"]+'</strong></h4><a href="http://'+data2[i]["facebook_messenger_url"]+'" target="_blank"><img src="https://annvivrqgp.cloudimg.io/v7/khadam.online/img/messenger.png" class="img img-fluid"></img></a>  <p><button class="btn btn-primary" type="button" data2-toggle="collapse" data2-target="#'+data2[i]["first_name"].split(" ")[0]+'" aria-expanded="false" aria-controls="'+data2[i]["first_name"].split(" ")[0]+'">عرض المزيد</button></p><div class="collapse" id="'+data2[i]["first_name"].split(" ")[0]+'"><div class="card card-body">'+data2[i]["caption"]+'</div></div></div></div></div>';
      }
    }
    };
...
function filter(filter_value){
  ...
  if (this.readyState == 4 && this.status == 200) {
    ...
    document.getElementById('search-filter').innerHTML += '<div class="col-lg-3 col-md-6 mb-4" ><div class="card"><div class="view overlay"><a><div class="mask rgba-white-slight"></div></a></div><div class="card-body text-center"><h1><span class="badge  badge-primary">'+filtered[i]["work_type"]+'</span></h1><a href="" class="grey-text"><h2>'+filtered[i]["first_name"]+' '+filtered[i]["last_name"]+'</h2></a><h5><strong><a href="tel:0'+filtered[i]["phone_number"]+'" class="dark-grey-text"><img src="https://annvivrqgp.cloudimg.io/v7/khadam.online/img/phone.png?width=34" >  0'+filtered[i]["phone_number"]+'</a></strong></h5><h4 class="font-weight-bold blue-text"><strong>'+filtered[i]["wilaya_place"]+'<br>'+filtered[i]["commune"]+'</strong></h4><a href="http://'+filtered[i]["facebook_messenger_url"]+'" target="_blank"><img src="https://annvivrqgp.cloudimg.io/v7/khadam.online/img/messenger.png" class="img img-fluid"></img></a><p><button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#'+filtered[i]["first_name"].split(" ")[0]+'" aria-expanded="false" aria-controls="'+filtered[i]["first_name"].split(" ")[0]+'">عرض المزيد</button></p><div class="collapse" id="'+filtered[i]["first_name"].split(" ")[0]+'"><div class="card card-body">'+filtered[i]["caption"]+'</div></div></div></div></div>';
      }
        }
    };
    xmlhttp.open("GET", urldataapi, true);
...
function filter_place(){
  ...
  if (this.readyState == 4 && this.status == 200) {
    ...
    document.getElementById('search-filter').innerHTML += '<div class="col-lg-3 col-md-6 mb-4" ><div class="card"><div class="view overlay"><a><div class="mask rgba-white-slight"></div></a></div><div class="card-body text-center "><h1><span class="badge  badge-primary">'+worker+'</span></h1><a href="" class="grey-text"><h2>'+filtered_place[i]["first_name"]+' '+filtered_place[i]["last_name"]+'</h2></a><h5><strong><a href="tel:0'+filtered_place[i]["phone_number"]+'" class="dark-grey-text"><img src="https://annvivrqgp.cloudimg.io/v7/khadam.online/img/phone.png?width=34" >  0'+filtered_place[i]["phone_number"]+'</a></strong></h5><h4 class="font-weight-bold blue-text"><strong>'+filtered_place[i]["wilaya_place"]+'<br>'+filtered_place[i]["commune"]+'</strong></h4><a href="http://'+filtered_place[i]["facebook_messenger_url"]+'" target="_blank"><img src="img/messenger.png" class="img img-fluid"></img></a><p><button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#'+filtered_place[i]["first_name"].split(" ")[0]+'" aria-expanded="false" aria-controls="'+filtered_place[i]["first_name"].split(" ")[0]+'">عرض المزيد</button></p><div class="collapse" id="'+filtered_place[i]["first_name"].split(" ")[0]+'"><div class="card card-body">'+filtered_place[i]["caption"]+'</div></div></div></div></div>'
      }
        }
...
function filter_place_c(filter_value){
  ...
  if (place == 'الولاية') {
    ...
    document.getElementById('search-filter').innerHTML = "";
    for (var i = 0; i < filtered_place.length; i++) {
    document.getElementById('search-filter').innerHTML += '<div class="col-lg-3 col-md-6 mb-4" ><div class="card"><div class="view overlay"><a><div class="mask rgba-white-slight"></div></a></div><div class="card-body text-center"><a href="" class="grey-text"><h2>'+filtered_place[i]["first_name"]+' '+filtered_place[i]["last_name"]+'</h2></a><h5><strong><a href="tel:0'+filtered_place[i]["phone_number"]+'" class="dark-grey-text"><img src="https://annvivrqgp.cloudimg.io/v7/khadam.online/img/phone.png?width=34" >   0'+filtered_place[i]["phone_number"]+'</a></strong></h5><h4 class="font-weight-bold blue-text"><strong>'+filtered_place[i]["wilaya_place"]+'<br>'+filtered_place[i]["commune"]+'</strong></h4><a href="http://'+filter_place[i]["facebook_messenger_url"]+'" target="_blank"><img src="img/messenger.png" class="img img-fluid"></img></a><p><button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#'+filtered_place[i]["phone_number"]+'" aria-expanded="false" aria-controls="'+filtered_place[i]["phone_number"]+'">عرض المزيد</button></p><div class="collapse" id="'+filtered_place[i]["phone_number"]+'"><div class="card card-body">'+filtered_place[i]["caption"]+'</div></div></div></div></div>';
      }
    }
        }
    };

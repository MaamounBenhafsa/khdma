...
function none_filter(){
  ...
  if (this.readyState == 4 && this.status == 200) {
    ...
    document.getElementById('search-filter').innerHTML += '<div class="col-lg-3 col-md-6 mb-4" ><div class="card"><div class="view overlay"><a><div class="mask rgba-white-slight"></div></a></div><div class="card-body text-center"><h1><span class="badge  badge-primary">'+data[i]["work_type"]+'</span></h1><h2>'+data[i]["first_name"]+'  '+data[i]["last_name"]+'</h2></a><h5><strong><a href="tel:0'+data[i]["phone_number"]+'" class="dark-grey-text"><img src="https://annvivrqgp.cloudimg.io/v7/khadam.online/img/phone.png?width=34" >  0'+data[i]["phone_number"]+'</a></strong></h5><h4 class="font-weight-bold blue-text"><strong>'+data[i]["wilaya_place"]+'<br>'+data[i]["commune"]+'</strong></h4><a href="http://'+data[i]["facebook_messenger_url"]+'" target="_blank"><img src="https://annvivrqgp.cloudimg.io/v7/khadam.online/img/messenger.png" class="img img-fluid"></img></a>  <p><button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#'+data[i]["first_name"].split(" ")[0]+'" aria-expanded="false" aria-controls="'+data[i]["first_name"].split(" ")[0]+'">عرض المزيد</button></p><div class="collapse" id="'+data[i]["first_name"].split(" ")[0]+'"><div class="card card-body">'+data[i]["caption"]+'</div></div></div></div></div>';
      }
    }
    };
